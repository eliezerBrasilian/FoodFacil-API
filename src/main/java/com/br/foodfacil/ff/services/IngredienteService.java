...
public class IngredienteService {
    ...
    public ResponseEntity<Object> registraIngrediente(IngredienteDto ingredienteDto){
        try{
            var ingrediente = ingredienteRepository.save(new Ingrediente(ingredienteDto));
